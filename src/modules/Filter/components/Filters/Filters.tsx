...
import { setCountries } from "../../slice/filterSlice";
...
export const Filters: React.FC = () => {
  ...
  return (
    <div className={classes.container}>
      ...
      />
      {isFetching && (
        <div className={classes.textInfo}>Получение информации о странах</div>
      )}
      {isError && (
        <div className={classes.textError}>Ошибка при получении информации</div>
      )}
